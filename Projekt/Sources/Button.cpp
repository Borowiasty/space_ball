...
Button::Button(const std::vector <sf::Font>& fonts, const std::map<std::string, sf::Texture>& textures, const std::map <std::string, sf::SoundBuffer>& samples, const std::string text, const int size, int width, int height, const int position_x, const int position_y)
{
...
bool Button::step(sf::Vector2i mouse_pos)
{
...
sf::Text Button::contain_text() { return contain_text_; }
